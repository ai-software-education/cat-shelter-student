...
@pytest.mark.api
@allure.feature("API")
@allure.story("POST/auth/register")
...
@pytest.mark.api
@allure.feature("API")
@allure.story("POST/auth/register Boundary")
...
@allure.story("POST/auth/register Boundary")
@pytest.mark.parametrize("payload, description", BOUNDARY_PAYLOADS)
def test_register_user_name_boundary(api, openapi_validator, payload, description, auth_token):
